  ...
  return (
    <div className="relative flex items-center justify-center min-h-screen">
      ...
      <div className="relative z-10 w-full max-w-md px-6 sm:px-8">
        <div className="p-8 transition-all duration-500 bg-white border border-pink-200 shadow-2xl rounded-3xl">
          <div className="mb-8 text-center">
            <h2 className="mb-2 text-3xl font-bold text-transparent bg-gradient-to-r from-pink-500 to-pink-600 bg-clip-text">
              Đặt lại mật khẩu
            </h2>
            <p className="text-lg text-gray-600">
              Nhập thông tin để đặt lại mật khẩu
            </p>
            <div className="w-16 h-1 mx-auto mt-3 rounded-full bg-gradient-to-r from-pink-400 to-pink-600"></div>
          </div>

          <form onSubmit={handleFormSubmit}>
            <div className="flex items-center px-3 py-2 mb-4 border-2 border-pink-300 rounded-2xl bg-white/70">
              <MdOutlineMailOutline className="text-pink-500" />
              <input
            ...
            <div className="flex items-center px-3 py-2 mb-4 border-2 border-pink-300 rounded-2xl bg-white/70">
              <RiLockPasswordFill className="text-pink-500" />
              <input
                className="w-full pl-2 bg-transparent border-none outline-none"
                type="password"
                required
            ...
            <div className="flex items-center px-3 py-2 mb-6 border-2 border-pink-300 rounded-2xl bg-white/70">
              <RiLockPasswordFill className="text-pink-500" />
              <input
                className="w-full pl-2 bg-transparent border-none outline-none"
                type="password"
          ...
          <div className="mt-6 text-center">
            <a
              href="/login"
              className="text-sm transition-all duration-500 cursor-pointer hover:text-pink-600 hover:-translate-y-1"
            >
              ← Quay lại đăng nhập
            </a>
          </div>
        ...
        {/* Branding section */}
        <div className="mt-8 text-center text-pink-500 drop-shadow-lg">
          <h2 className="text-4xl font-bold tracking-wide">FASHION STORE</h2>
